...
<body onload="fondoDegradado('<?php echo $_INMO_COLOR1; ?>', '<?php echo $_INMO_COLOR2; ?>'); " onresize="fondoDegradado('<?php echo $_INMO_COLOR1; ?>', '<?php echo $_INMO_COLOR2; ?>'); pageSize = WindowUtilities.getPageSize();" >
...
<div id="menuPrincipal" style="display:none;">
  <table width="400" height="340" border="0" cellpadding="0" cellspacing="0" id="menu">
    <tr>
...
<?php
	...
	$menuItem_xsl->setXML(_FILE_XML_MENU_PRINCIPAL."?usr_login=".$_COOKIE['usuario']['usr_login']."&usr_id=".$usr_id);
	$menuItem_xsl->setXSL(_FILE_XSL_MENU_PRINCIPAL_ITEM);
	$menuItem_xsl->Transform();
...
<div id="menuBarra" >
  <table width="100%" height="35" border="0" cellpadding="0" cellspacing="0" >
    <tr style="background:url(interfaz/inmohost/images/barra/fondo1.png) repeat-x;" height="55">
      <td width="420" valign="top"><div id="menuBarraLeft">
      <?php
      	
			$menu_xsl = new MM_XSLTransform();
			$menu_xsl->setXML(_FILE_XML_MENU_PRINCIPAL."?usr_id=".$usr_id);
			$menu_xsl->setXSL(_FILE_XSL_MENU_PRINCIPAL);
			echo $menu_xsl->Transform();
		?>
      </div></td>
      <td width="54" ><img src="interfaz/inmohost/images/barra/solapa.png" width="54" height="55" border="0"  /></td>
      <td width="38" valign="top"><a href="javascript:abrir_red();" title="Red de Corredores Inmobiliarios"><img src="interfaz/inmohost/images/barra/icono_red.png" border="0" width="38" height="55" align="left" /></a></td>
      <td width="100%"><div align="center" style="height:15px; color:#FF6600; font-size:12px; font-weight:bold;" id="pieMensajes"></div></td>
      <td width="79"><div align="right"><a href="javascript:cerrarSesion(<?php echo $usr_id?>);" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('cerrar','','interfaz/inmohost/images/barra/close_f2.png',1)"><img src="interfaz/inmohost/images/barra/close.png" alt="cerrar sesion" name="cerrar" width="79" height="55" border="0" id="cerrar" /></a></div></td>
    </tr>
  </table>
</div>
...
<div id="bannerPrincipal">
    ...
    <?php 
    /*if($usr_id != 2128){?>
            <div style="position: relative;top: 180px;left: 550px"> 
                <div style="vertical-align: bottom"> <img src="system/extra/banners/flyer_after_2013_mail.jpg" width="680px"/>  </div>
            </div>
    <?php }*/
    ?>
</div>
...
//	so.addVariable("fileXML", "<?php echo "proxy.php?tip=banner_principal&usr_id=$usr_id"; ?>");
...
<form id="ingreso" name="ingreso" method="post" action="">
            <table width="200" border="0" align="center" cellpadding="0" cellspacing="5">
              ...
              <tr>
                ...
                <td width="50%"><input name="usuario" type="text" class="inputForm" id="userLogin" tabindex="1" style="width:100px" onkeypress="if (event.keyCode == 13){renovarSesion();}" /></td>
              </tr>
              <tr>
                <td>
                	<div align="right">
                ...
                <td>
                	<input name="pass" type="password" class="inputForm" id="passLogin" tabindex="2" style="width:100px" onkeypress="if (event.keyCode == 13){renovarSesion();}"/>
                        <input name="usuario_id" id="usuario_id" value="<?php echo $usr_id?>" type="hidden"/>
                </td>
              </tr>
            </table>
    </form>
