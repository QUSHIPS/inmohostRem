...
?>
        <tr>
          <td><form id="ingreso" name="ingreso" method="post" action="<?php print $rutaAbsoluta."system/php/sec_chequea.php"; ?>">
            <table width="200" border="0" align="center" cellpadding="0" cellspacing="5">
            <input type="hidden" name="usr_id" value="<?php echo $usr_id?>">
              <!--tr>
                <td width="50%">
                	<div align="right">
	                    <h2>Codigo de Empresa:</h2>
    	            </div>
    	        </td>
                <td width="50%"><input name="usr_id" type="text" class="inputForm" id="usr_id" tabindex="1" style="width:100px" /></td>
              </tr-->
              ...
              <tr>
                ...
                <td width="50%"><input name="usuario" value="<?php echo $usuario?>" type="text" class="inputForm" id="user" tabindex="1" style="width:100px" onkeypress="if (event.keyCode == 13){document.ingreso.submit();}" /></td>
              </tr>
              <tr>
                <td>
                	<div align="right">
                ...
                <td>
                	<input name="pass" value="<?php echo $password?>" type="password" class="inputForm" id="pass" tabindex="2" style="width:100px" onkeypress="if (event.keyCode == 13){document.ingreso.submit();}"/>
