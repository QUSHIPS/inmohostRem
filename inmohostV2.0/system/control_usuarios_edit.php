...
<script language="javascript" type="text/javascript">
	...
	function modificar_usr(){
	 	if(document.agendaUsuariosEditar.usr_pass.value==document.agendaUsuariosEditar.usr_pass2.value){
	 		if(verif('nombre,1,Nombre,apellido,1,Apellido,usr_login,1,Login,usr_pass,1,Contraseña,usr_pass2,1,Contraseña Nuevamente,hh_s,2,Hora Sesion','agendaUsuariosEditar')){
...
<?php
	...
	$fileXML = _FILE_XML_USUARIOS_EDIT."?emp_id=$emp_id&usr_id=".$usr_id;
