...
<?php
	...
	if(isset($fileXML) && isset($fileXSL)){
		...
		$new_xsl->addParameter("fileCalendario", _FILE_PHP_MEN_CALENDARIO."&usr_id="._USR_ID);
		...
		$new_xsl->addParameter("fileAgendaCitasInteresados", _FILE_AGENDA_MEN_CITA_INTERESADOS."&usr_id="._USR_ID);
		$new_xsl->addParameter("fileAgendaCitasVerInt",_FILE_AGENDA_MEN_CITA_VER_INT."&usr_id="._USR_ID);
