...
function error($numero,$texto, $archivo, $linea){
	...
	//Esto lo conseguiremos indicando al interprete Zend que llame a la funci�n error() cada vez que el c�digo PHP contenga un error con la funci�n set_error_handler:
