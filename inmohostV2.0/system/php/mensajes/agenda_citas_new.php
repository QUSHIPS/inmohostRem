...
?>
    ...
    <tr class="tableClara" >
      <td colspan="2" align="center">
        ...
        &nbsp;&nbsp;
		<input name="agendar" type="button" class="botonForm" id="agendar" onclick="if(verif('hora,2,Hora,cita_desc,1,Detalles,emp_id,2,Monitor','agendaCitaAgregar'))document.agendaCitaAgregar.submit();" value="Agendar" tabindex="7" />
        </td>
    </tr>
  </table>
</form>
