<?php
	...
	//projectconfiguracion class
	
	define("_PROJECT_CONFIGURACION_CLASS",'/home/inmoclick/domains/inmoclick.com.ar/inmoclick/config/ProjectConfiguration.class.php');
	...
	define("_PROJECT_CONFIGURACION_CLASS",'/home/inmoclick/domains/inmoclick.com.ar/private_html/config/ProjectConfiguration.class.php');
	
	define("_PROJECT_CONFIGURACION_CLASS_CHILE","/home/chileprop/domains/chilepropiedades.com/chilepropiedades/config/ProjectConfiguration.class.php");
	
	define("_URL_INMOCLICK","http://www.inmoclick.com.ar");

	define("_FOTOS_INMOCLICK",'/home/inmoclick/domains/inmoclick.com.ar/public_html/ftp_inmohost/fotos/');
	
	// Si viene de internet el generico siempre entra por el dominio
	if ($internet)
	{
		define("_FILE_HTML_GENERICO", "https://".$dominio_local."/inmohostV2.0/".$rutaSystemAbs."generico_html.php");
	}
	else
	{
	...
	define("_DOMINIO_ACTUAL","localhost/online");
...
/************************************************/
	...
	define("_FILE_PHP_PRP_MAP", $rutaSystema."map.php");	
	...
	// AGENDA
		...
		//ABM
			...
			define("_FILE_PHP_ABM_DEM", $rutaSystema."php/abms/abm_dem.php");	
			 ...
			 //WEB
                define("_FILE_XML_CONSULTAS_HEAD", $rutaAbsoluta.$rutaSystemAbs.$carpetaDatos."agenda_consultas_listadoHead.xml.php");
                define("_FILE_XML_CONSULTAS_LISTADO", $rutaAbsoluta.$rutaSystemAbs.$carpetaDatos."agenda_consultas_listadoResultado.xml.php");
		     define("_FILE_XML_VISITAS_HEAD", $rutaAbsoluta.$rutaSystemAbs.$carpetaDatos."agenda_visitas_listadoHead.xml.php");
                define("_FILE_XML_VISITAS_LISTADO", $rutaAbsoluta.$rutaSystemAbs.$carpetaDatos."agenda_visitas_listadoResultado.xml.php");
	...
	//FUNCION DE EMAIL
	define("_FILE_PHP_MAILER", $rutaSystema."php/classes/phpmailer/class.phpmailer.php");
...
/************************************************************/
	...
	//formularios
		...
		define("_FILE_FORM_WWW_CONSULTAS", $rutaSystemAbs."formularios/www_consultas.php");
		define("_FILE_FORM_WWW_VISITAS", $rutaSystemAbs."formularios/www_visitas.php");
		//INFORMES
			//propiedades
	...
	//MENSAJES DEL SISTEMA
		...
		define("_FILE_RED_MEN_INMOBILIARIA", $rutaAbsoluta.$rutaSystemAbs."php/mensajes/red_inmobiliaria.php");
		  ...
		  //AYUDA
         define("_FILE_PDF_AYUDA", $rutaAbsoluta.$rutaSystemAbs."extra/ayuda_inmohost.pdf");
         define("_FILE_INFO_SERVICIO_TECNICO", $rutaAbsoluta.$rutaSystemAbs."php/mensajes/servicio_tecnico.php");
...
/********************************/
	...
	define("_FILE_JAVASCRIPT_MAPS", $rutaSystema."javascript/maps.js");
	define("_FILE_JAVASCRIPT_TINYMCE", $rutaSystema."extra/tiny_mce/tiny_mce.js");
	define("_FILE_JAVASCRIPT_ADDGALERY", $rutaSystema."javascript/jquery/imageGalery/jquery.ad-gallery2.js");
        define("_FILE_JAVASCRIPT_ADDGALERY_IMAGES", $rutaSystema."javascript/jquery/imageGalery/");
        define("_FILE_CSS_ADDGALERY", "/online/inmohostV2.0/interfaz/inmohost/css/jquery.ad-gallery.css");
