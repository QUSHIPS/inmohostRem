...
<xsl:for-each select="bar_priv/columna">
    <tr class="tableClara">
      ...
      <td><div align="center"><a href="javascript:;" onclick="eliminar_bar_priv('{bar_id}','{usr_id}');traeURL('system/formularios/panel_bar_priv.php?usr_id={usr_id}', 'contenidoMenuActual5');" title="quitar" class="menuItem"><img src="interfaz/inmohost/images/iconos/20/eliminar.png" width="20" height="20" border="0" /></a></div></td>
    </tr>
</xsl:for-each>
  </table>
</xsl:template>
