...
<table width="240" border="0" align="center" cellpadding="0" cellspacing="0" id="tablaMorir">
  <tr>
	...
	<input type="hidden" name="fileXMLListado" value="<?php echo _FILE_XML_CITAS_LISTADO; ?>"  />
	<input type="hidden" name="fileXMLHead" value="<?php echo _FILE_XML_CITAS_HEAD; ?>"  />
		...
		<table width="100%" border="0" cellpadding="1" cellspacing="1" class="tableOscura" id="tablaListarCitas" style="display:none">
              ...
              <tr class="tableClara">
				...
				<input id="desdeCitasAno" type="hidden" name="desdeCitasAno" value="0000" />
                  <a href="javascript:;" title="seleccionar fecha" class="menu" onclick="position(event); toolTip('<?php echo _FILE_PHP_MEN_CALENDARIO; ?>&destino=desdeCitas&usr_id=<?php echo $usr_id?>',this)" tabindex="2"><img src="interfaz/inmohost/images/iconos/calendario.gif" width="16" height="15" border="0" align="absmiddle" /></a>
				  </td>
              </tr>
              <tr class="tableClara">
				...
				<input id="hastaCitasAno" type="hidden" name="hastaCitasAno" value="0000" />
                  <a href="javascript:;" title="seleccionar fecha" class="menu" onclick="position(event); toolTip('<?php echo _FILE_PHP_MEN_CALENDARIO; ?>&destino=hastaCitas&usr_id=<?php echo $usr_id?>',this)" tabindex="3"><img src="interfaz/inmohost/images/iconos/calendario.gif" width="16" height="15" border="0" align="absmiddle" /></a>
				  </td>
              </tr>
              <tr class="tableClara">
              ...
              <tr class="tableClara">
                ...
                <td><select name="ver_canceladas" class="inputForm" onkeypress="if (event.keyCode == 13){chequeaForm('FormAgendaCitas', '<?php echo $destino1; ?>', '<?php echo $titulo; ?>', '<?php echo $url1; ?>', '<?php echo $parametros; ?>');}" tabindex="5">
                      ...
                      <option value="2">Mostradas</option>
