...
?>
        ...
        <tr>
          ...
          <td><div align="center"><a href="#" title="Agregar Demanda" class="menuItem" tabindex="13" onclick="display('menuPrincipal');ventana('alt_dem','&mod_tip=add&fileXML=<?echo $file_dem?>&fileXSL=<?echo _FILE_XSL_DEMANDAS?>','<?echo _FILE_PHP_DEMANDAS?>','Alta de Pedido');"><img src="interfaz/inmohost/images/iconos/20/demanda.png" width="20" height="20" border="0" /><br />
            Agregar<br />
            Pedido</a></div></td>
       </tr>
      </table>
