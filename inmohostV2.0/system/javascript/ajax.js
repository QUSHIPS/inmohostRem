...
{
	document.getElementById("div_"+nameID).innerHTML = "<select "+multiple+" name=\"pro_id\" id=\"pro_id\" onchange=\"act_select('loc_id,loc_desc','localidades','pro_id='+this.value,'loc_id','','php/funciones','loc_id');\" class=\"inputForm\" tabindex=\"1\">"+resultado+"</select>";
	document.getElementById("div_loc_id").innerHTML = "<select "+multiple+" name=\"loc_id\" id=\"loc_id\" onchange=\"\" class=\"inputForm\" tabindex=\"1\"><option value=\"0\">Indistinto</option></select>";
}
function act_div_loc_id(multiple)
{
	document.getElementById("div_"+nameID).innerHTML = "<select name=\"loc_id\" id=\"loc_id\" "+multiple+" onchange=\"\" class=\"inputForm\" tabindex=\"1\">"+resultado+"</select>";
}
