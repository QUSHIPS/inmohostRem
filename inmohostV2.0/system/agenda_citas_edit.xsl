...
<table width="100%" height="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="tableOscura">
    ...
    <tr class="tableClara" >
	  ...
	  <input name="fechaCita" type="text" id="fechaCita" value="{cita/fecha}" class="inputFecha" readonly="yes" />
			...
			<a id="iniciaForm" href="javascript:;" title="seleccionar fecha" class="menu" onclick="position(event); toolTip('{$FILECALENDARIO}&amp;destino=fechaCita',this)" tabindex="1"><img src="../interfaz/inmohost/images/iconos/calendario.gif" width="16" height="15" border="0" align="absmiddle" /></a>
    </td>
    </tr>
    <tr class="tableClara" 	>
    ...
    <tr class="tableClara" >
      <td colspan="2" align="center"><input name="agendar" type="button" class="botonForm" id="agendar" onclick="if(verif('hora,2,Hora,cita_desc,1,Detalles,emp_id,2,Monitor','agendaCitaEditar'))document.agendaCitaEditar.submit();" value="Agendar" />
        &nbsp;&nbsp;
        </td>
    </tr>
  </table>
