		...
		<inmodb>
			...
			<inmodb>
					<cabezera>
						<head id="prp_pre" tamano="10" link=""><![CDATA[Precio]]></head>
						<head id="prp_dom" tamano="5" link=""><![CDATA[Domicilio]]></head>
						<head id="prp_desc" tamano="5" link=""><![CDATA[Descripcion]]></head>
						<head id="prp_nota" tamano="5" link=""><![CDATA[Nota]]></head>
						<head id="dormitorios" tamano="5" link=""><![CDATA[Cant. Dormitorios]]></head>
						<head id="prp_id" tamano="5" link=""><![CDATA[ID]]></head>
						<head id="tip_desc" tamano="5" link=""><![CDATA[Tipo]]></head>
