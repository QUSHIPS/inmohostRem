...
<table width="100%" border="0" cellspacing="0" cellpadding="3">
  ...
  <tr >
    ...
    <td width="50%"><h1 align="right" onclick="position(event); toolTip('{$fileCalendario}&amp;destino=citasListado&amp;prp_id={$prp_id}',this);"><a title="buscar fecha" ><img src="../interfaz/inmohost/images/iconos/calendario.gif" width="16" height="15" hspace="5" align="absmiddle" />buscar fecha&nbsp;&nbsp;&nbsp;</a></h1></td>
  </tr>
