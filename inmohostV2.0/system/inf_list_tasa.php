...
<?php
	...
	if(isset($fileXMLListado) && isset($fileXSLListado)){
		...
		$new_xsl->setXML($fileXMLListado."?tipo_inf=$tipo_inf&base=$base&desdeMosDia=$desdeMosDia&desdeMosMes=$desdeMosMes&desdeMosAno=$desdeMosAno&hastaMosDia=$hastaMosDia&hastaMosMes=$hastaMosMes&hastaMosAno=$hastaMosAno&con_id=$con_id&tip_id=$tip_id&est_can=$est_can&usr_id=$usr_id");
