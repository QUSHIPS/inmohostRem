...
<div align="center"><br/>
	...
	if ($errors)
	{
		...
		if($mod_tip=="edit"){
			echo "<br/><br/><input type='button' value='Cerrar' onclick=\"parent.Windows.close('edicionSimple');\" class='botonForm'><br/>";
		}else{
			echo "<br/><br/><input type='button' value='Cerrar' onclick='hideToolTip();' class='botonForm'><br/>";
		}
	}
	?>
