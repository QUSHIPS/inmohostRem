		...
		<table width="100%" border="0" cellpadding="1" cellspacing="1" class="tableOscura" id="tablaListarDemandas" >
              ...
              <!--tr class="tableClara">
               ...
               <tr class="tableClara">
                ...
                <td><input name="dem_pre_min_dol" type="text" class="inputForm" id="prp_id4" tabindex="9" style="width:90px"  value="{XMLTEXTO/datos/dem_pre_min}"/> 
                  y
                    <input name="dem_pre_max_dol" type="text" class="inputForm" id="prp_id5" tabindex="10" style="width:90px"  value="{XMLTEXTO/datos/dem_pre_max}"/></td>
              </tr>
               <tr class="tableClara">
              ...
              <tr class="tableClara">
		          <td width="150%" colspan="5">
		            <h1 align="left">Cruzar demandas con:</h1>
					<hr />
					</td>
                  </tr>
                  <tr class="tableClara">
	                <td><div id="dem_raz_div" align="right">Inmobiliaria:</div></td>
	                <td><input type="checkbox" name="dem_inmobiliaria"  tabindex="19" value="1" checked="{XMLTEXTO/datos/dem_inmobiliaria}"/></td>
              	</tr>
              	 <tr class="tableClara">
	                <td><div id="dem_tel_div" align="right">Red de inmobiliarias(inmoclick)</div></td>
	                <td><input type="checkbox" name="dem_red_inmoclick" tabindex="20" value="2" checked="{XMLTEXTO/datos/dem_red_inmoclick}"/></td>
              	</tr>
              ...
              <tr class="tableClara">
                <td colspan="2"><div align="center">
                  ...
                  <input type="button" class="botonForm" tabindex="9" value="Modificar" onclick="valida_formulario('dem_raz,1,Razon Social,dem_tel,1,Telefono,dem_mail,3,E-Mail,aux_loc_id,7,Localidad,aux_tip_id,7,Tipo de Construccion,aux_con_id,7,Condicion','agendaDemandaEditar');"/>
                </div></td>
                </tr>
