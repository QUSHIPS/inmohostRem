...
?>
 ...
 <tr>
   <td><div align="center"> <a href="javascript:ventana('actualizador','propiedades=1&medios=0&act_red_cim=1', '<?php echo _FILE_PHP_ACTUALIZADOR; ?>', 'Actualizando el Sistema'); display('menuPrincipal');" class="menuItem"><img src="interfaz/inmohost/images/iconos/32/actualizar.png" alt="Actualizar" width="32" height="32" hspace="3" vspace="5" border="0" align="absmiddle" /><br />
    Actualizar</a></div></td>
 </tr>
<?	
}else{
