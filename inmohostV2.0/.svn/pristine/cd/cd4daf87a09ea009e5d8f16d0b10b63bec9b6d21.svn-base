		...
		if($e==1){
			?>
				<script language="Javascript">
						...
						alert("Ocurrio un error al subir sus propiedades. Pongase en contacto con el soporte técnico de INMOHOST. \n\rGracias");
				</script>
			<?php 
		...
		if($e==1){
			...
			?>
				<script language="Javascript">
						...
						parent.display("menuPrincipal");
						parent.Dialog.okCallback();
						alert("Ocurrio un error al subir sus barrios privados. Pongase en contacto con el soporte técnico de INMOHOST. \n\rGracias");
				</script>
			<?php 
		}else{
		...
		if($e==1){
			?>
				<script language="Javascript">
						...
						parent.display("menuPrincipal");
						parent.Dialog.okCallback();
						alert("Ocurrio un error al subir sus empleados. Pongase en contacto con el soporte técnico de INMOHOST. \n\rGracias");
				</script>
