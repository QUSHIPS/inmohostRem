...
//	$existe_propiedad=mysql_query("SELECT fotos FROM propiedades WHERE prp_id=$prp_id AND usr_id=$usr_id") or die("No se pudo recuperar el tipo de foto");	
	...
	if(($mod_tip=="add"&&$duplicar) || $mod_tip=="edit")
	{
			...
			if (mysql_num_rows($cons_prop)){
				...
				$mos_por_4=$cons_prp[mos_por_4];
				$prp_anonimo=$cons_prp[prp_anonimo];
				$prp_lat=$cons_prp[prp_lat];
				$prp_lng=$cons_prp[prp_lng];
				$prp_ocultar_precio=$cons_prp[prp_ocultar_precio];
				$fo360_id=$cons_prp[fo360_id];
...
*/
			...
			<propiedad>
		        ...
		        <mos_por_4><![CDATA[$mos_por_4]]></mos_por_4>
		        ...
		        <prp_ocultar_precio><![CDATA[$prp_ocultar_precio]]></prp_ocultar_precio>
		        <fo360_id><![CDATA[$fo360_id]]></fo360_id>
	...
	else if ($mod_tip=="add")
        {
			...
			<propiedad>
		        				...
		        				<mos_por_4><![CDATA[0]]></mos_por_4>
		        				<cartel><![CDATA[NO]]></cartel>
		        				<prp_aut><![CDATA[0]]></prp_aut>
		        				<prp_vip><![CDATA[NO]]></prp_vip>
                                                         <prp_ocultar_precio><![CDATA[0]]></prp_ocultar_precio>
                                                         <fo360_id><![CDATA[0]]></fo360_id>
";
			echo "<imagenes>";
	        for ($i=1; $i<16; $i++)
	        {
