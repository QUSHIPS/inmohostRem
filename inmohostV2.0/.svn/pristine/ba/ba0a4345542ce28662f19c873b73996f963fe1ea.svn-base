                ...
                <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" class="tableOscura" id="alta_{med_id}_{$ID}" style="margin:1px">
                  <tr class="tableClara">
                    <td width="80%"><h2>
                            ...
                            <td width="20%"><h1 align="center" onclick="mostrar_cal(event,'{$fileCalendario}','{$POS}',{med_id},{$ID},'check_{$POS}',{position()} )"><a title="Ingresar fecha" ><img src="../interfaz/inmohost/images/iconos/calendario.gif" width="16" height="15" hspace="5" align="absmiddle" /></a></h1></td>
                          </tr>
                </table>
              </xsl:for-each>
            </div>            </td>
