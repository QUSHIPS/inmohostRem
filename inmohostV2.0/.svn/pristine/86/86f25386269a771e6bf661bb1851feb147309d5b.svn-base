    ...
    <tr class="tableClara">
		  ...
		  <table width="100%" border="0" cellpadding="1" cellspacing="1" class="tableOscura" id="tablaEditUsuarios">
              ...
              <tr class="tableClara">
                ...
                <td><input name="usr_pass" type="password" class="inputForm" id="usr_pass" style="width:70px" tabindex="26"  value="{usuario/password}" /></td>
              </tr>
              <tr class="tableClara">
                <td><div align="right" id="usr_pass2_div">Repita la Contraseña:</div></td>
                <td><input name="usr_pass2" type="password" class="inputForm" id="usr_pass2" style="width:70px" tabindex="27"    value="{usuario/password}"/></td>
              </tr>
              <tr class="tableClara">
