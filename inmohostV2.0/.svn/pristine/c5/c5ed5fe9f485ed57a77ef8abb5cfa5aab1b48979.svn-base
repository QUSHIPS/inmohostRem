...
<script language="javascript" type="text/javascript">
	...
	function agregar_usr(){
	 	if(document.controlUsuarioAgregar.usr_pass.value==document.controlUsuarioAgregar.usr_pass2.value){
	 		if(verif('nombre,1,Nombre,apellido,1,Apellido,usr_login,1,Login,usr_pass,1,Contraseña,usr_pass2,1,Contraseña Nuevamente,hh_s,2,Hora Sesion','controlUsuarioAgregar')){
...
<?php
	if(isset($fileXML) && isset($fileXSL)){
		...
		$new_xsl->setXML($fileXML."?usr_id=".$usr_id);
