    ...
    if(document.getElementById(form).id=='prp_edit_form'){
        ...
        switch(select_tip_id){
            ...
            case '6': case '24': case '25':
                aux +=',valor14,2,Agua,valor12,2,Luz Electrica,valor18,2,Cloacas,valor15,2,Gas,valor2,1,Sup. Total m2,valor2,9,10,valor27,5,Precio por m2';
            break;
        }
    }
       a = a + aux;
...
function precio_venta_lotes(a,b,form){
        ...
        if(valor != '' && valor!=0 && parseInt(valor) < parseInt(10000)){
