...
<table width="100%" height="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="tableOscura">
    ...
    <tr class="tableClara" >
      <td colspan="2" align="center"><input name="agendar" type="button" class="botonForm" id="agendar" onclick="alert(document.agendaCitaEditar.min.value);document.agendaCitaEditar.submit();" value="Agendar" />
        &nbsp;&nbsp;
