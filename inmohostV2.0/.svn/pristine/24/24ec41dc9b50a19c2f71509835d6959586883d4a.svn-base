  ...
  <tr>
    <td><form id="FormPanelInterfaz" name="FormPanelInterfaz" method="post" action="">
      <table width="100%" border="0" cellpadding="1" cellspacing="1">
          ...
          <td><table width="100%" border="0" cellpadding="0" cellspacing="1" class="tableOscura">
            ...
            <tr class="tableClara">
              ...
              <td width="50%"><div align="center">
                <h1><a href="javascript:;" title="seleccionar color" class="menu" onclick="position(event); toolTip('<?php echo _FILE_PHP_MEN_PALETA; ?>&color=<?php echo $_INMO_COLOR1; ?>&destino=color1&usr_id=<?php echo $usr_id?>',this)" tabindex="2"><img id="imagen_color1" src="interfaz/inmohost/images/iconos/color.gif" width="21" height="20" align="right" style="background-color:#<?php echo $_INMO_COLOR1; ?>" /></a><span id="text_color1">#<?php echo $_INMO_COLOR1; ?></span></h1>
            ...
            <tr class="tableClara">
              ...
              <td width="50%"><div align="center">
                <h1><a href="javascript:;" title="seleccionar color" class="menu" onclick="position(event); toolTip('<?php echo _FILE_PHP_MEN_PALETA; ?>&color=<?php echo $_INMO_COLOR2; ?>&destino=color2&usr_id=<?php echo $usr_id?>',this)" tabindex="2"><img id="imagen_color2" src="interfaz/inmohost/images/iconos/color.gif" width="21" height="20" align="right" style="background-color:#<?php echo $_INMO_COLOR2; ?>" /></a><span id="text_color2">#<?php echo $_INMO_COLOR2; ?></span></h1>
            ...
            <tr class="tableClara">
              <td colspan="2"><div align="center">
                ...
                <input name="Submit" type="button" class="botonForm" value="Guardar" onclick="fondoDegradado(document.getElementById('inmo_color1').value, document.getElementById('inmo_color2').value);guardarDatosInterfaz(document.getElementById('inmo_color1').value,document.getElementById('inmo_color2').value,'<?php echo $_COOKIE['usuario']['usr_login'];?>'); display('menuPrincipal');" onkeypress="fondoDegradado(document.getElementById('inmo_color1').value, document.getElementById('inmo_color2').value); display('menuPrincipal');" />
          </div></td>
              </tr>
            <tr class="tableClara">
            <td colspan="2">&nbsp;</td>
        ...
        <tr>
          <td><div align="center">
            <input name="Submit" type="button" class="botonForm" value="Guardar" onclick="fondoDegradado(document.getElementById('inmo_color1').value, document.getElementById('inmo_color2').value);guardarDatosInterfaz(document.getElementById('inmo_color1').value,document.getElementById('inmo_color2').value,'<?php echo $_COOKIE['usuario']['usr_login'];?>');" onkeypress="fondoDegradado(document.getElementById('inmo_color1').value, document.getElementById('inmo_color2').value);" />
          </div></td>
        </tr-->
      </table>
        </form>
