...
<table width="100%" height="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="tableOscura">
  ...
  <tr class="tableClara" >
    <td height="20" align="center"><div align="right"><?php echo $label1?>:</div></td>
    <td height="20" ><?php print $apellido?></td>
  </tr>
  <tr class="tableClara" >
    <td height="20" align="center"><div align="right"><?php echo $label2?>:</div></td>
    <td height="20"><?php print $nombre?></td>
  </tr>
  <tr class="tableClara" >
    <td height="20" align="center"><div align="right">Tel&eacute;fono:</div></td>
    <td height="20"><?php print $telefono?></td>
  </tr>
  <tr class="tableClara" >
    <td height="20" align="center"><div align="right">Domicilio:</div></td>
    <td height="20"><?php print $domicilio?></td>
  </tr>
  <tr class="tableClara" >
    <td width="30%" height="20" align="center"><div align="right">E-mail:</div></td>
    <td width="70%" height="20"><?php print $mail?></td>
  </tr>
    
  <tr class="tableClara" valign="top" >
    <td height="100%" align="center"><div align="right">Nota:</div></td>
    <td height="100%" ><?php print $nota?></td>
  </tr>
  <tr class="tableClara" >
